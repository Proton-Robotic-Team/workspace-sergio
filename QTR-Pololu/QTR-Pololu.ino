...
void setup() {
  ...
  qtr.setTypeAnalog();
  qtr.setSensorPins((const uint8_t[]){ PIN_D1, PIN_D2, PIN_D3, PIN_D4, PIN_D5, PIN_D6, PIN_D7, PIN_D8 }, SensorCount);
  //qtr.setEmitterPin(2);

  delay(500);
  pinMode(PIN_LED_ONBOARD, OUTPUT);
  digitalWrite(PIN_LED_ONBOARD, HIGH);  // turn on Arduino's LED to indicate we are in calibration mode
  ...
  digitalWrite(PIN_LED_ONBOARD, LOW);  // turn off Arduino's LED to indicate we are through with calibration
